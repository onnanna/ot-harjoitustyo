...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_syö_maukkaasti_ei_vie_saldoa_negatiiviseksi(self):
    ...
    def test_kortille_ei_voi_ladata_negatiivista_summaa(self):
        self.kortti.lataa_rahaa(-1100)
        self.assertEqual(self.kortti.saldo_euroina(), 10.0)

    def test_pystyy_ostamaan_edullisen_lounaan_kun_saldo_on_saman_verran(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

        self.assertEqual(kortti.saldo_euroina(), 0.0)

    def test_pystyy_ostamaan_maukkaan_lounaan_kun_saldo_on_saman_verran(self):
